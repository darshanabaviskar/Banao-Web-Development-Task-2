...
let colors = [
  ...
  },
  {
    ...
    head: "<p>The Next Big</p><h1>Blockchain</h1><p style='text-align: right'>Revolution</p>",
  },
  {
    backgroundColor: "#0f113b",
    head: "<p>Powered by advanced</p><img src='./images/nasa-mobile-app.png' style='height:60px;' alt='nasa' /><p style='text-align: right'>algorithms</p>",
  },
  {
    backgroundColor: "#17263c",
    head: "<p>Redefining</p><h1>UX Strategy</h1><p style='text-align: right'>and UI design</p>",
  },
  {
    backgroundColor: "#134ca2",
    head: "<p>Text Headline</p><h1>Text Headline</h1><p style='text-align: right'>Footer headline</p>",
  },
  {
    backgroundColor: "#022b92",
    head: "<p>Developing ERP Solutions for</p><h1>Text Headline</h1><p style='text-align: right'>in furniture industry</p>",
  },
  {
    backgroundColor: "#01824d",
    head: "<p>Biggest Classifieds</p><h1>East Asia</h1><p style='text-align: right'>Countries</p>",
  },
];
